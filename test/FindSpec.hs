...
spec = do
  ...
  describe "relative listing" $ do
    it "lists relative files" $ do
      ...
      res @?= ["./CopySpec.hs", "./data", "./drain.hs", "./drain.sh", "./EnvSpec.hs", "./FindSpec.hs", "./main.hs", "./ReadFileSpec.hs", "./WriteSpec.hs"]

    it "finds relative files" $ do
      res <- shelly $ cd "test" >> find "."
      res @?= ["./CopySpec.hs", "./data", "./data/zshrc", "./drain.hs", "./drain.sh", "./EnvSpec.hs", "./FindSpec.hs", "./main.hs", "./ReadFileSpec.hs", "./WriteSpec.hs"]
  ...
  describe "find" $ do
    ...
    it "lists relative files" $ do
      ...
      res @?= ["test/CopySpec.hs", "test/data", "test/data/zshrc", "test/drain.hs", "test/drain.sh", "test/EnvSpec.hs", "test/FindSpec.hs", "test/main.hs", "test/ReadFileSpec.hs", "test/WriteSpec.hs"]
